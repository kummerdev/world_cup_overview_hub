...
In resume this project is live **FIFA World Cup 2026** tracker built with Flask and the free ESPN public API. Scores update automatically — no API key, no manual entry required.
